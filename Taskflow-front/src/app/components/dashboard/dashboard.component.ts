      ...
      <aside class="sidebar">
        ...
        <div class="user-profile">
          ...
          <div class="user-info">
            ...
            <span class="role-badge" [class.badge-admin]="isAdmin">{{ role }}</span>
          </div>
        </div>
      ...
      <main class="main-content">
        <header class="content-header">
          <div>
            ...
            <p class="subtitle">Gestiona y organiza tus actividades corporativas</p>
          </div>
          ...
          <form (ngSubmit)="saveTarea()">
            <div class="form-group">
              ...
              <input 
                ...
                required
                placeholder="Ej. Escribir documentación técnica"
              />
            </div>
            ...
            <div class="form-group">
              ...
              <textarea 
                ...
                required
                placeholder="Detalla los requisitos o pasos de la tarea..."
              ></textarea>
            </div>
...
export class DashboardComponent implements OnInit {
  ...
  loadUserProfile() {
    this.username = this.authService.obtenerUsername() || 'Usuario';
    const rawRole = this.authService.obtenerRol() || 'USER';
    this.role = rawRole === 'ADMIN' ? 'Administrador' : 'Colaborador';

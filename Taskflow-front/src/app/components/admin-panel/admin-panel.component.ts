                  ...
                  @for (t of filteredTareas; track t.id) {
                    <tr>
                      ...
                      <td class="actions-cell">
                        ...
                        <button (click)="onDelete(t.id)" class="btn-icon btn-delete" title="Eliminar (Forzado)">
...
export class AdminPanelComponent implements OnInit {
  ...
  onDelete(id: number) {
    if (confirm('¿Está seguro de que desea eliminar permanentemente esta tarea como Administrador?')) {
